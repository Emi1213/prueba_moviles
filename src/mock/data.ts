import { Semester } from './IInterface'
      ...
      subjects: [
        {
          ...
          assignments: [
            ...
            },
            {
              ...
              description: 'Implementación de métodos numéricos',
              dueDate: new Date('2024-05-20T23:59:59'),
              status: 'pending',
              grade: null,
              resources: [],
            },
          ...
          assignments: [
            {
              ...
              description: 'Implementar una API REST con Node.js',
              dueDate: new Date('2024-04-10T23:59:59'),
              status: 'graded',
              grade: 28,
              feedback: 'Excelente implementación de seguridad',
              resources: [
                {
                  id: 'REC002',
                  name: 'Especificaciones API.docx',
                  type: 'document',
                  url: '/resources/api-specs.docx',
                },
              ],
            },
          ],
